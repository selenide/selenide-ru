...
Если вы используете какой-нибудь вебдрайвер (или кастомный `WebDriverProvider`), WebDriverManager просто не запустится, и у вас всё будет по-прежнему. 
...
Совсем скоро мы планируем выпустить Selenide 4.8 с обновлением до selenium 3.6.0. 
Оно содержит некоторые обратно несовместимые изменения, так что возможно, прольётся немножко крови. 
