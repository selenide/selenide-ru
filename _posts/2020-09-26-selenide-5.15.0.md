...
Естественно, логично выставить настройку `Configuration.clickViaJs` в то значение, которое вам подходит в большинстве случае, и задавать параметр `ClickOptions` точечно - только там, где он необходим. 
...
Естественно, логично выставить настройку `Configuration.fileDownload` в то значение, которое вам подходит в большинстве случае, и задавать параметр `DownloadsOptions` точечно - только там, где он необходим. 
...
```java
`$("a").shouldHave(href("/foo/bar/details.html"))`  --  see PR #1273
```
