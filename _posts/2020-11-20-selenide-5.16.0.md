...
Целый блок улучшений сообщений об ошибках:
...
например, с их помощью можно определять составные условия (с целью переиспользования).
...
Нам это надоело, и теперь в селениде явно прописана свежая версия Guava `30.0-jre`.  
