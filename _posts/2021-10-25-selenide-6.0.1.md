...
Спасибо См. [Boris Osipov](https://github.com/BorisOsipov) за 
...
Спасибо См. [Boris Osipov](https://github.com/BorisOsipov) за [PR 1619](https://github.com/selenide/selenide/pull/1619).
...
* Ребята из Aurokube выпустили [альтернативный клиент WebDriver](https://github.com/aerokube/lightning-java). Теоретически теперь селенид может работать на нём вместо Selenium Webdriver. Звучит заманчиво? 
