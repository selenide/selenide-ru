...
description: ""
category:
headerText: "режим бога в Selenide"
tags: []
---
Привет, друзья!
...
* [Обновились до selenium 3.11.0](#updade-to-selenium-3.11.0)
* [Добавили условие `textsInAnyOrder`](#texts-in-any-order)
* [Местоположение браузера на экране](#browser-position)
* [Скачивать файлы с русскими буквами в названии](#download-files-with-cyrillic-letters)
* [Добавили возможность передавать `chromeoptions.prefs`](#chrome-prefs)
* [Перехватчики запросов/ответов в прокси](#proxy-filters)
* [Метод `$.followLink()` помечен как deprecated](#deprecate-follow-link)
* [NullPointerException в SelenideReport](#null-pointer-in-selenide-report)
* [Скриншот для софт ассертов](#take-screenshot-for-soft-asserts)
* [Новости](#news)
* [Ресурсы](#resources)
...
# Теперь можно указать местоположение браузера на экране {#browser-position}
...
# Теперь Selenide умеет скачивать файлы с русскими буквами в названии {#download-files-with-cyrillic-letters}
...
# Теперь вы можете добавлять в прокси-сервер свои перехватчики для запросов/ответов {#proxy-filters}
...
# Исправили случайный NullPointerException в SelenideReport {#null-pointer-in-selenide-report}
...
# Исправили ошибку, когда при софт ассертах не делался скриншот {#take-screenshot-for-soft-asserts}
