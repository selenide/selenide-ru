...
description: ""
category:
headerText: "Маленький шаг навстречу Котлину"
tags: []
---
Привет!
...
[Здесь](https://github.com/selenide-examples/kotlin/blob/main/src/test/kotlin/SelenideUsersTest.kt) можно посмотреть некоторые варианты, как это можно было решить. 
