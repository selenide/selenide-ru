...
description: ""
category:
headerText: "Эмуляция мобильного браузера"
tags: []
---
Всем привет!
...
* [Эмуляция мобильного браузера](#mobile-browser-emulation)
* [Пометили метод `Selenide.close()` как устаревший](#deprecated-selenide-close)
* [Новости](#news)

<br/> 

# Добавили эмуляцию мобильного браузера {#mobile-browser-emulation}
...
> UPD Позже мы добавили метод, чтобы включать-выключать эмуляцию мобильника   
> [без рестарта вебдрайвера](/2025/10/29/selenide-7.12.0/#mobile-emulation):
> 
