...
description: ""
category:
headerText: "Selenide Advent Calendar<br/>День 1"
tags: []
---
Всем привет!
...
Чтобы дождаться наступления какого-то события, вам не нужно писать лишний код типа такого:
...
В селениде всё проще: любая строчка типа этой тупо **автоматически ждёт**, если надо:
