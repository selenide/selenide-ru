...
header-text: >
  ...
  Просто добавь в проект <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/4.14.2/selenide-4.14.2.jar">selenide.jar</a> и начинай писать тест.<br>
