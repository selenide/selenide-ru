...
header-text: >
  ...
  Просто добавь в проект <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/5.2.7/selenide-5.2.7.jar">selenide.jar</a> и начинай писать тест.<br>
