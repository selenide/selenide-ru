...
header-text: >
  ...
  Просто добавь в проект <a href="https://search.maven.org/remotecontent?filepath=com/codeborne/selenide/5.2.4/selenide-5.2.4.jar">selenide.jar</a> и начинай писать тест.<br>
